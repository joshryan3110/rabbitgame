...
function setup() 
{
  ...
  starDisplay = createSprite(80,30,30,30)
  starDisplay.addAnimation("empty",emptyStar)
  starDisplay.addAnimation("1star",oneStar)
  starDisplay.addAnimation("2star",twoStar)
  starDisplay.changeAnimation("empty")
  starDisplay.scale=0.3
...
function draw() 
{
  ...
  if(collideStar(fruit,star1,20)===true){
    star1.visible=false
    starDisplay.changeAnimation("1star")
  }
  if(collideStar(fruit,star2,20)===true){
    star2.visible=false
    starDisplay.changeAnimation("2star")
  }
...
function collideStar(body1,body2,x){
  if(body1!=null){
